...
prompt="""You are an AI agent specialized in SUMO (Simulation of Urban Mobility) traffic simulation and VANET (Vehicular Ad-hoc Network) security analysis.
...
def analyze_simulation_data_with_llm(model_name="qwen3:1.7b", custom_prompt=prompt):
