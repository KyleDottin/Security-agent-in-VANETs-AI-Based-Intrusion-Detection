...
# [RED TOOL]
@mcp.tool("Traffic Light Tampering Attack", description="Simulates an attack by forcing all lights of TL1 to red and yellow (blinking) for a short period, then all green. Assumes the simulation is already running and TraCI is connected.")
